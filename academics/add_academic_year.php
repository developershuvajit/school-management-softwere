                    ...
                    <div class="col-xl-12 col-xxl-12">
                        <div class="card">
                            <div class="card-header d-flex justify-content-between align-items-center flex-wrap">
                                <h4 class="card-title mb-2 mb-sm-0">Add New Academic Year</h4>
                                <a href="academic_year_list.php" class="btn btn-secondary">
                                    <i class="fa fa-list"></i> View All Academic Years
                                </a>
                            </div>
                            ...
                            <div class="card-body">
                                <form method="POST" action="../actions/academic_year_actions.php">
                                    ...
                                    <div class="text-center mt-3">
                                        <button type="submit" name="add_academic_year" class="btn btn-primary px-4">
