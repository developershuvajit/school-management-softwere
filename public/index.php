            ...
            <div class="row">
                ...
                <div class="col-lg-3 col-sm-6">
                    <div class="card">
                        <div class="stat-widget-one card-body">
                            ...
                            <div class="stat-content d-inline-block">
                                <div class="stat-text">Fees Collected</div>
                                <div class="stat-digit">₹1,20,000</div>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-3 col-sm-6">
                    <div class="card">
                        <div class="stat-widget-one card-body">
                            ...
                            <div class="stat-content d-inline-block">
                                <div class="stat-text">Fees Due</div>
                                <div class="stat-digit">₹25,000</div>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-3 col-sm-6">
                    <div class="card">
                        <div class="stat-widget-one card-body">
                            <div class="stat-icon d-inline-block">
                                <i class="ti-book text-info border-info"></i>
                            </div>
                            <div class="stat-content d-inline-block">
                ...
                <div class="col-lg-3 col-sm-6">
                    <div class="card">
                        <div class="stat-widget-one card-body">
                            <div class="stat-icon d-inline-block">
                                <i class="ti-calendar text-warning border-warning"></i>
                            </div>
                            <div class="stat-content d-inline-block">
                ...
                <div class="col-lg-3 col-sm-6">
                    <div class="card">
                        <div class="stat-widget-one card-body">
                            <div class="stat-icon d-inline-block">
                                <i class="ti-check-box text-info border-info"></i>
                            </div>
                            <div class="stat-content d-inline-block">
                                <div class="stat-text">Attendance Today</div>
                                <div class="stat-digit">92/100</div>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-3 col-sm-6">
                    <div class="card">
                        <div class="stat-widget-one card-body">
                            <div class="stat-icon d-inline-block">
                                <i class="ti-pencil-alt text-primary border-primary"></i>
                            </div>
                            <div class="stat-content d-inline-block">
                                <div class="stat-text">New Admissions</div>
